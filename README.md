<h1 align="center">Nishant Sorout</h1>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/GitOps-EF7B4D?style=for-the-badge&logo=argo&logoColor=white" />
  <img src="https://img.shields.io/badge/Cloud_Security-1E90FF?style=for-the-badge&logo=datadog&logoColor=white" />
</p>
...
| **Ops, Cost & Governance** | CloudWatch · EventBridge · SNS · SQS · SES · Cost Explorer · Organizations · Control Tower · Systems Manager |
...
- Integrated **AWS IAM Identity Center** with **Azure Entra ID** (SAML/SCIM) for centralized, least-privilege access
- Automated monthly **FinOps** cost reporting (Lambda, EventBridge, Cost Explorer, SES) and optimized client cloud spend
...
*Deep-dive engineering blogs that break down how things actually work under the hood — in plain language for engineers and newcomers alike.*

| | |
|---|---|
| 📦 | **What Actually Happens Inside Kubernetes** — The Hidden Cost of `kubectl apply` |
| 🗺️ | **How Terraform Really Tracks State** — Drift, Diffs & the Apply Lifecycle |
